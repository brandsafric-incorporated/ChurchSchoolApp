...
namespace ChurchSchool.Repository.Migrations
{
    ...
    [Migration("20180510042553_RemovingNullFromRemovedDateField")]
    partial class RemovingNullFromRemovedDateField
    {
            ...
            modelBuilder.Entity("ChurchSchool.Domain.Entities.Course", b =>
                {
                    b.Property<Guid?>("Id")
                        .ValueGeneratedOnAdd()
                        .HasDefaultValue(new Guid("a32bee79-c7ba-4ae0-a821-92b3e8fd2c28"));
            ...
            modelBuilder.Entity("ChurchSchool.Domain.Entities.CourseClass", b =>
                {
                    ...
                    b.Property<Guid?>("Id")
                        .ValueGeneratedOnAdd()
                        .HasDefaultValue(new Guid("aea5762a-c45d-457d-9aa1-679caf46497e"));
            ...
            modelBuilder.Entity("ChurchSchool.Domain.Entities.CourseClass_Student", b =>
                {
                    ...
                    b.Property<Guid?>("Id")
                        .ValueGeneratedOnAdd()
                        .HasDefaultValue(new Guid("9f0e6552-4abb-48c9-aeb0-f568d13a1d2e"));
            ...
            modelBuilder.Entity("ChurchSchool.Domain.Entities.CourseClass_Subject", b =>
                {
                    ...
                    b.Property<Guid?>("Id")
                        .ValueGeneratedOnAdd()
                        .HasDefaultValue(new Guid("7df98b47-9e2f-4929-94de-84dd76fffc72"));
            ...
            modelBuilder.Entity("ChurchSchool.Domain.Entities.CourseConfiguration", b =>
                {
                    b.Property<Guid?>("Id")
                        .ValueGeneratedOnAdd()
                        .HasDefaultValue(new Guid("4d860fff-8b73-4d9b-a2fe-3d37e5b5809c"));
            ...
            modelBuilder.Entity("ChurchSchool.Domain.Entities.Curriculum", b =>
                {
                    b.Property<Guid?>("Id")
                        .ValueGeneratedOnAdd()
                        .HasDefaultValue(new Guid("2a0a45f8-8f90-404b-8cff-df768012ea72"));
            ...
            modelBuilder.Entity("ChurchSchool.Domain.Entities.Curriculum_Subject", b =>
                {
                    ...
                    b.Property<Guid?>("Id")
                        .ValueGeneratedOnAdd()
                        .HasDefaultValue(new Guid("e2de9a75-dd22-41ea-8f72-2c69ceba706b"));
            ...
            modelBuilder.Entity("ChurchSchool.Domain.Entities.Enrollment", b =>
                {
                    b.Property<Guid?>("Id")
                        .ValueGeneratedOnAdd()
                        .HasDefaultValue(new Guid("1566b070-6b33-45a5-8f87-d187cfd424fc"));
            ...
            modelBuilder.Entity("ChurchSchool.Domain.Entities.Frequency", b =>
                {
                    ...
                    b.Property<Guid?>("Id")
                        .ValueGeneratedOnAdd()
                        .HasDefaultValue(new Guid("b2f11f3a-d95e-4360-9bf5-c0ee5197305c"));
            ...
            modelBuilder.Entity("ChurchSchool.Domain.Entities.Grade", b =>
                {
                    b.Property<Guid?>("Id")
                        .ValueGeneratedOnAdd()
                        .HasDefaultValue(new Guid("78878d87-ffe0-41ce-ab9e-c1287ec0a50c"));
            ...
            modelBuilder.Entity("ChurchSchool.Domain.Entities.GradeHistory", b =>
                {
                    b.Property<Guid?>("Id")
                        .ValueGeneratedOnAdd()
                        .HasDefaultValue(new Guid("66c6d983-c5e0-457e-a246-52c0db06f29a"));
            ...
            modelBuilder.Entity("ChurchSchool.Domain.Entities.Person", b =>
                {
                    b.Property<Guid?>("Id")
                        .ValueGeneratedOnAdd()
                        .HasDefaultValue(new Guid("6374a709-fe42-4d07-89fb-52969eda4306"));
            ...
            modelBuilder.Entity("ChurchSchool.Domain.Entities.ScholarTerm", b =>
                {
                    b.Property<Guid?>("Id")
                        .ValueGeneratedOnAdd()
                        .HasDefaultValue(new Guid("777a9cdc-41f2-4a4b-b1ce-e6ad5fd1e8f8"));
            ...
            modelBuilder.Entity("ChurchSchool.Domain.Entities.Subject", b =>
                {
                    b.Property<Guid?>("Id")
                        .ValueGeneratedOnAdd()
                        .HasDefaultValue(new Guid("3f87908f-8df8-484d-9804-c547bf840e93"));
