...
namespace ChurchSchool.Repository.Migrations
{
    ...
    [Migration("20180510044218_FixingDefaultToInsertDateField")]
    partial class FixingDefaultToInsertDateField
    {
            ...
            modelBuilder.Entity("ChurchSchool.Domain.Entities.Course", b =>
                {
                    b.Property<Guid?>("Id")
                        .ValueGeneratedOnAdd()
                        .HasDefaultValue(new Guid("c84b4c5e-ffdd-458a-9219-aac5ae52b65b"));
            ...
            modelBuilder.Entity("ChurchSchool.Domain.Entities.CourseClass", b =>
                {
                    ...
                    b.Property<Guid?>("Id")
                        .ValueGeneratedOnAdd()
                        .HasDefaultValue(new Guid("794c439d-e9be-4207-9f6e-9658bb09041d"));
            ...
            modelBuilder.Entity("ChurchSchool.Domain.Entities.CourseClass_Student", b =>
                {
                    ...
                    b.Property<Guid?>("Id")
                        .ValueGeneratedOnAdd()
                        .HasDefaultValue(new Guid("cfe541f3-2339-4ca2-9bfd-59d504381e5c"));
            ...
            modelBuilder.Entity("ChurchSchool.Domain.Entities.CourseClass_Subject", b =>
                {
                    ...
                    b.Property<Guid?>("Id")
                        .ValueGeneratedOnAdd()
                        .HasDefaultValue(new Guid("6bdb4c26-0de4-4578-8fcc-516fd7d5ec21"));
            ...
            modelBuilder.Entity("ChurchSchool.Domain.Entities.CourseConfiguration", b =>
                {
                    b.Property<Guid?>("Id")
                        .ValueGeneratedOnAdd()
                        .HasDefaultValue(new Guid("646e3ba1-541f-4a80-a143-10261531c996"));
            ...
            modelBuilder.Entity("ChurchSchool.Domain.Entities.Curriculum", b =>
                {
                    b.Property<Guid?>("Id")
                        .ValueGeneratedOnAdd()
                        .HasDefaultValue(new Guid("8f9cf6fd-38a7-4691-8818-b0836a852107"));
            ...
            modelBuilder.Entity("ChurchSchool.Domain.Entities.Curriculum_Subject", b =>
                {
                    ...
                    b.Property<Guid?>("Id")
                        .ValueGeneratedOnAdd()
                        .HasDefaultValue(new Guid("8869f3e4-0359-4e31-9721-ab585e012b35"));
            ...
            modelBuilder.Entity("ChurchSchool.Domain.Entities.Enrollment", b =>
                {
                    b.Property<Guid?>("Id")
                        .ValueGeneratedOnAdd()
                        .HasDefaultValue(new Guid("fcf1c87f-e6ec-433d-9fb3-c9b4e1a816f0"));
            ...
            modelBuilder.Entity("ChurchSchool.Domain.Entities.Frequency", b =>
                {
                    ...
                    b.Property<Guid?>("Id")
                        .ValueGeneratedOnAdd()
                        .HasDefaultValue(new Guid("d324557b-e224-48dc-a81f-6d97765038ce"));
            ...
            modelBuilder.Entity("ChurchSchool.Domain.Entities.Grade", b =>
                {
                    b.Property<Guid?>("Id")
                        .ValueGeneratedOnAdd()
                        .HasDefaultValue(new Guid("a70a6923-90fd-4ce9-8c3f-f220a2c019c5"));
            ...
            modelBuilder.Entity("ChurchSchool.Domain.Entities.GradeHistory", b =>
                {
                    b.Property<Guid?>("Id")
                        .ValueGeneratedOnAdd()
                        .HasDefaultValue(new Guid("cd193f0a-06f1-4963-a632-2d0fd61f6ecd"));
            ...
            modelBuilder.Entity("ChurchSchool.Domain.Entities.Person", b =>
                {
                    b.Property<Guid?>("Id")
                        .ValueGeneratedOnAdd()
                        .HasDefaultValue(new Guid("3667b75b-8e66-4895-966b-702f6aad02bb"));
            ...
            modelBuilder.Entity("ChurchSchool.Domain.Entities.ScholarTerm", b =>
                {
                    b.Property<Guid?>("Id")
                        .ValueGeneratedOnAdd()
                        .HasDefaultValue(new Guid("70009968-85b7-4aad-9684-6154d6070c88"));
            ...
            modelBuilder.Entity("ChurchSchool.Domain.Entities.Subject", b =>
                {
                    b.Property<Guid?>("Id")
                        .ValueGeneratedOnAdd()
                        .HasDefaultValue(new Guid("e1639d82-8734-4e51-8552-3832409fa33a"));
