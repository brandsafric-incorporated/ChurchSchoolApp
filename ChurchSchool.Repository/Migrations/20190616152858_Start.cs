        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ProfileImage = table.Column<string>(type: "VARCHAR(5000)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Details = table.Column<string>(type: "VARCHAR(5000)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    UpdatedDate = table.Column<DateTime>(type: "datetime", nullable: true),
                    RemovedDate = table.Column<DateTime>(type: "datetime", nullable: true),
                    CourseConfigurationId = table.Column<long>(nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    UpdatedDate = table.Column<DateTime>(type: "datetime", nullable: true),
                    RemovedDate = table.Column<DateTime>(type: "datetime", nullable: true),
                    Curriculum_SubjectId = table.Column<long>(nullable: false),
                    ProfessorId = table.Column<long>(nullable: false),
                    Description = table.Column<string>(type: "varchar(500)", nullable: false),
